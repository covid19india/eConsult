...
<script type="text/javascript" src="<?php echo erLhcoreClassDesign::designJS('vendor/jquery/jquery.min.js;js/modernizr.js;js/lh.js;js/jquery.hotkeys.min.js');?>"></script>