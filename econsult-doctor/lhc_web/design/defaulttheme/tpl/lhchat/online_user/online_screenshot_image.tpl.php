...
<input type="button" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/screenshot','Refresh')?>" class="btn btn-secondary btn-sm" onclick="lhinst.updateScreenshotOnline('<?php echo $online->id?>')" />
<?php endif;?>