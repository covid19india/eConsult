...
<div class="row form-group">
	...
	<div class="col-3">
		<select class="form-control form-control-sm" id="markerTimeout" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/onlineusers','Marker timeout before it dissapears from map');?>">
