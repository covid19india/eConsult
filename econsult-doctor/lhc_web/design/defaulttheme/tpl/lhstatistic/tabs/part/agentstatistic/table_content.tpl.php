...
<td><a href="<?php echo erLhcoreClassDesign::baseurl('statistic/onlinehours')?><?php echo erLhcoreClassSearchHandler::getURLAppendFromInput($input);?>/(user_ids)/<?php echo $info->userId?>"><?php echo $info->totalHoursOnline_front; ?></a></td>
